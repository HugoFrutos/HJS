                    ...
                    $.ajax({
                        ...
                        $('#btneditar').unbind().click(function(){
                            ...
                            diente = $("#txtdientee").val();
                             ...
                             oka = {
						                "txttipotratamientoe" : tipotratamiento , "idTratamiento" : id,
                                        "txtpacientee" : paciente , "txtfechaInicioe" : fechaInicio,
                                        "txtProxConse" : proxCon , "txtObse" : obse, "txtdientee" : diente,
                                };
                            //alert(oka);
